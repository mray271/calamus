...
- **Tabbed editing** — open multiple Markdown files side by side
...
*Release notes are updated by maintainers at release time. For full details, see [CHANGELOG.md](CHANGELOG.md).*
